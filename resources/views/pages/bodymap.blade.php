      ...
      <div class="col-xs-12 ">
				<nav>
					<div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
						<a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Where is the problem?</a>
						<a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">What is the problem?</a>
				...
				<div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                  ...
                  <map name = "tutorials">
                     ...
                     <area shape="poly" 
                        ...
                        href = "#" alt = "Perl Tutorial" title="Gastrologist"
                        target = "_self" 
