...
<li style="float:right"><a class="active" href="/show_pat_medication">Medication</a></li>
...
<div id="sidebar">
    <button class="button_sidebar button1">Current Medication</button>
    <button class="button_sidebar button1">Search Medicine</button>
    <button class="button_sidebar button1">Medication History</button>
</div>
