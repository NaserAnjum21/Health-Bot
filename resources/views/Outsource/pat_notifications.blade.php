...
<li style="float:right"><a class="active" href="/show_pat_notifications">Notification</a></li>
<li style="float:right"><a href='/show_pat_home'>Home</a></li>
</ul>

<div id="sidebar">
    <button class="button_sidebar button1">2 New Notifications</button>
    <button class="button_sidebar button1">Mark All as Read</button>
    <button class="button_sidebar button1">Clear All Notifications</button>
</div>
