         ...
         <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="height" value="{{ $patient->height }}" class="form-control" placeholder="Height">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Blood Group:</strong>
                    <input type="text" name="bloodgroup" value="{{ $patient->bloodgroup }}" class="form-control" placeholder="Blood Group">
                </div>
            </div>
